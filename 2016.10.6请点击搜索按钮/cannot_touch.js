...
{
    document.getElementsByName('btnG')[0].onmouseover = over_btn;
    document.getElementsByName('btnK')[0].onmouseover = over_btn;
    document.getElementsByName('btnI')[0].onmouseover = over_btn;
}
else if(document.domain=="www.lofter.com")
{
    document.getElementById('dologin').onmouseover = over_btn;
}
